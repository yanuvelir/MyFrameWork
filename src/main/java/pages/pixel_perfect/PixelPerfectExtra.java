...
public class PixelPerfectExtra extends Action {

    public PixelPerfectExtra(WebDriver driver) {
        super(driver);
    }

    public void ppByElement(String ElementXpath, String RealLifeScreenShotPath, String MockFilePath,
...
//
//    public PpByElement inputEmail(String text) {
//
...
//    }
//
//    public PpByElement inputPassword(String text) {
//
